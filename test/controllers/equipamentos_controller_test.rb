...
class EquipamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipamento" do
    assert_difference('Equipamento.count') do
      post equipamentos_url, params: { equipamento: { funcao: @equipamento.funcao, laboratorio_id: @equipamento.laboratorio_id, nome: @equipamento.nome, taxa: @equipamento.taxa } }
    end
  ...
  test "should update equipamento" do
    patch equipamento_url(@equipamento), params: { equipamento: { funcao: @equipamento.funcao, laboratorio_id: @equipamento.laboratorio_id, nome: @equipamento.nome, taxa: @equipamento.taxa } }
