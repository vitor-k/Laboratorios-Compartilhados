...
class LaboratoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratorio" do
    assert_difference('Laboratorio.count') do
      post laboratorios_url, params: { laboratorio: { descricao: @laboratorio.descricao, localizacao: @laboratorio.localizacao, nome: @laboratorio.nome } }
    end
  ...
  test "should update laboratorio" do
    patch laboratorio_url(@laboratorio), params: { laboratorio: { descricao: @laboratorio.descricao, localizacao: @laboratorio.localizacao, nome: @laboratorio.nome } }
